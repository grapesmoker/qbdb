  ...
  return sequelize.define('Tossup', {
    ...
    classMethods: {
      ...
      addFullTextIndex: function() {
        ...
        Object.keys(searchFields).forEach(function(e) {
          searchVector.push("setweight(to_tsvector('english', coalesce("+searchFields[e]+",'')), '"+e+"')");
        });
